...
class StreamReassembler {
 private:
  ...
  struct Segment {
    ...
    bool operator<(const Segment& other) const {
      return _first_index < other._first_index;
    }
  };
  std::set<Segment> _buffers{};
  ...
  long merge_data(Segment& elem1, const Segment& elem2);
 ...
 public:
  ...
  //! \brief Receives a substring and writes any newly contiguous bytes into the
  //! stream.
  //!
